...
#define US_TRIG_RIGHT_Pin GPIO_PIN_0
#define US_TRIG_RIGHT_GPIO_Port GPIOB
#define US_ECHO_LEFT_Pin GPIO_PIN_1
#define US_ECHO_LEFT_GPIO_Port GPIOB
#define US_ECHO_LEFT_EXTI_IRQn EXTI1_IRQn
#define US_ECHO_RIGHT_Pin GPIO_PIN_2
#define US_ECHO_RIGHT_GPIO_Port GPIOB
#define US_ECHO_RIGHT_EXTI_IRQn EXTI2_IRQn
#define US_TRIG_LEFT_Pin GPIO_PIN_10
#define US_TRIG_LEFT_GPIO_Port GPIOB
